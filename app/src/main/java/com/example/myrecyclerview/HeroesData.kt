...
object HeroesData {
    private val data = arrayOf(
        arrayOf(
            "Ahmad Dahlan",
            "Salah seorang Ulama dan Khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itudan ibu dari K.H Ahmad Dahlan adalahputri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningratpada masa itu.K.h Ahmad Dahlan telah mempelopori kebangkitan ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah yang masih harus belajar dan berbuat.",
            "http://upload.wikimedia.org/wikipedia/commons/8/87/Ahmad_Dahlan.jpg"
        ),
        arrayOf(
            "Ahmad Yani",
            "Jendral TNI Anumarta Ahmad Yani (juga dieja Achmad Yani; lahir di Purwokerto,Jawa Tengah,19 juni 1922 - menunggal di Lubang Buava ,Jakarta,1 Oktober 1965 pada umur 43 tahun) adalah komandan Tentara Nasional Indonesia Angkatan Darat,dan dibunuh oleh anggota Gerakan 30 September saat mencoba untuk menculik dia dari rumahnya.",
